...
def test_deve_permitir_propor_um_lance_quando_o_valor_eh_igual_ao_valor_da_carteira():
    vini = Usuario('Vini', 100.0)
...
def test_nao_deve_permitir_propor_lance_com_valor_maior_do_que_da_carteira():
    vini = Usuario('Vini', 100.0)
